...
object EnumHandler {
   ...
   */
  def handler[ValueType <: AnyVal, EntryType <: ValueEnumEntry[ValueType]](enum: ValueEnum[ValueType, EntryType])(implicit
    baseBsonReader: BSONReader[BSONValue, ValueType],
                                                                                                                  baseBsonWriter: BSONWriter[ValueType, BSONValue]): BSONHandler[BSONValue, EntryType] = new BSONHandler[BSONValue, EntryType] {
