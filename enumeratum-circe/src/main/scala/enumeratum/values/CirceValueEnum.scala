...
/**
  ...
  */
trait IntCirceEnum[EntryType <: IntEnumEntry]
    extends CirceValueEnum[Int, EntryType] { this: ValueEnum[Int, EntryType] =>
...
/**
  ...
  */
trait LongCirceEnum[EntryType <: LongEnumEntry]
    extends CirceValueEnum[Long, EntryType] {
...
/**
  ...
  */
trait ShortCirceEnum[EntryType <: ShortEnumEntry]
    extends CirceValueEnum[Short, EntryType] {
...
/**
  ...
  */
trait StringCirceEnum[EntryType <: StringEnumEntry]
    extends CirceValueEnum[String, EntryType] {
...
/**
  ...
  */
trait CharCirceEnum[EntryType <: CharEnumEntry]
    extends CirceValueEnum[Char, EntryType] {
...
/**
  ...
  */
trait ByteCirceEnum[EntryType <: ByteEnumEntry]
    extends CirceValueEnum[Byte, EntryType] {
