...
object EnumFormats {
   ...
   */
  def reads[ValueType <: AnyVal, EntryType <: ValueEnumEntry[ValueType]](enum: ValueEnum[EntryType, ValueType])(implicit baseReads: Reads[ValueType]): Reads[EntryType] = new Reads[EntryType] {
   ...
   */
  def writes[ValueType <: AnyVal, EntryType <: ValueEnumEntry[ValueType]](enum: ValueEnum[EntryType, ValueType])(implicit baseWrites: Writes[ValueType]): Writes[EntryType] = new Writes[EntryType] {
   ...
   */
  def formats[ValueType <: AnyVal, EntryType <: ValueEnumEntry[ValueType]](enum: ValueEnum[EntryType, ValueType])(implicit baseReads: Reads[ValueType], baseWrites: Writes[ValueType]): Format[EntryType] = {
